...
PRETRAINED_MODEL_ARCHIVE_MAP = {
    ...
    'bert-large-uncased-whole-word-masking': "./resources/pytorch-pretrained-BERT/pytorch_model.bin",
...
PRETRAINED_CONFIG_ARCHIVE_MAP = {
    ...
    'bert-large-uncased-whole-word-masking': "./resources/pytorch-pretrained-BERT/config.json",
